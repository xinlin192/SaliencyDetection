...
and keep the largest $\chi^2$ value: 
    ...
    \footnotesize Fig. Feature Maps of Center-Surrond Histograms under various scenes
    \end{center}
...
\begin{thebibliography}{99} \fontsize{9pt}{50} \setlength{\itemsep}{-0.5pt} 
    ...
    \bibitem 6 Gould, Stephen. "DARWIN: A Framework for Machine Learning and Computer Vision Research and Development." 
