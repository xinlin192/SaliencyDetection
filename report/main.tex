...
\begin{figure}
    ...
    \footnotesize \hspace{0.1cm} (a) \hs (b) \hs  (c) \hs (d) \\
    \caption{Feature Maps of Centre-Surrond Histograms under various scenes}
    \end{center}
\end{figure}
...
\begin{figure}
    ...
    \footnotesize \hspace{0.1cm} (a) \hs (b) \hs  (c) \hs (d) \\
     \caption{Feature Maps of Color Spatial Distribution under various scenes}
    \end{center}
\end{figure}
...
\begin{figure}
    ...
    \caption{Examples for global feature using diluted images}
    \end{center}
\end{figure}
