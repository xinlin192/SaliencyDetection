...
\subsection{Color Spatial Distribution}
    The goal of using Color Spatial Distribution feature is to take the global saliency information into account. 
    ...
    \footnotesize Fig. Feature Maps of Color Spatial Distribution
    \end{center}
    ...
    trade-off between precision and time performance. Tricks to improve the performance.

    Goodness of this feature
