...
\begin{abstract}
%{{{
    MSRA datasets, we detect the saliency of by extracting local, 
    ...
    approach is evaluated. Our implementation will employ the  OpenCV library, 
    leveraging on the ANU's open source DARWIN framework to achieve a CRF-based saliency detection algorithm. 
