...
The unary potential, combining the three pixel features, is specified as $$S_{unary}(a_x,I) = \SUM_{k=1}^K \lambda_k \cdot F_k(a_x,I)$$ where $\lambda_k$ is the cross-validated weight of the $k^{th}$ feature such that $\sum_{k=1}^{K} \lambda_k = 1$.
